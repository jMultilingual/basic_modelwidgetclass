...
from PySide6.QtCore import (QSaveFile, QFile, QIODevice, QDataStream,
                            QSize, Qt, QMetaType, QByteArray, QMimeData)
import sys
import resources
...
class ListWidget(QListWidget):
    ...
    def dropMimeRead(self, index, out):
    ...
    def dropMimeData(self, index, data, action):
        ...
        if data.hasUrls():
            ...
            qb = data.data('application/x-qabstracttablewidgetdatalist')
